        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:+256700000000" className="flex gap-3 text-sm text-green-200 hover:text-[#F4720B] transition-colors">
                  <Phone size={16} className="text-[#F4720B] shrink-0" />+256 700 000 000
                </a>
              </li>
              <li>
                <a href="mailto:info@visionafricanchild.ug" className="flex gap-3 text-sm text-green-200 hover:text-[#F4720B] transition-colors">
